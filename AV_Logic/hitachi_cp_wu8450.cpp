...
void HITACHI_CP_WU8450::sendCommand(HITACHI_CP_WU8450::HITACHI_COMMANDS cmd) {
    ...
    int SET_POWER_ON[]     = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xba, 0xd2, 0x01, 0x00, 0x00, 0x60, 0x01, 0x00};
    int SET_POWER_OFF[]    = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x2a, 0xd3, 0x01, 0x00, 0x00, 0x60, 0x00, 0x00};
    int REQUEST_POWER[]    = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x19, 0xd3, 0x02, 0x00, 0x00, 0x60, 0x00, 0x00};
    // Command,               Header-----------------------,----CRC----, --Action--,----Type---, Setting Code
    int SET_VOL_UP[]       = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xab, 0xc3, 0x04, 0x00, 0x50, 0x20, 0x00, 0x00};
    int SET_VOL_DOWN[]     = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x7a, 0xc2, 0x05, 0x00, 0x50, 0x20, 0x00, 0x00};
    int SET_VOL_MUTE_ON[]  = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xd6, 0xd2, 0x01, 0x00, 0x02, 0x20, 0x01, 0x00};
    int SET_VOL_MUTE_OFF[] = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x46, 0xd3, 0x01, 0x00, 0x02, 0x20, 0x00, 0x00};
    int REQUEST_VOL[]      = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xcd, 0xc3, 0x02, 0x00, 0x50, 0x20, 0x00, 0x00};
    int REQUEST_VOL_MUTE[] = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x75, 0xd3, 0x02, 0x00, 0x02, 0x20, 0x00, 0x00};
    // Command,                       Header-----------------------,----CRC----, --Action--,----Type----, Setting Code
    int LOAD_LENS_1[]              = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x4b, 0x92, 0x01, 0x00, 0x07, 0x24, 0x00, 0x00};
    int LOAD_LENS_2[]              = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xdb, 0x93, 0x01, 0x00, 0x07, 0x24, 0x01, 0x00};
    int LOAD_LENS_3[]              = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x2b, 0x93, 0x02, 0x00, 0x07, 0x24, 0x02, 0x00};
    int LOAD_LENS_EXECUTE[]        = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xe8, 0x90, 0x06, 0x00, 0x08, 0x24, 0x00, 0x00};
    // Command,               Header------------------------,----CRC----, --Action--,----Type----, Setting Code
    int SET_BLANK_ON[]      = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x6b, 0xd9, 0x01, 0x00, 0x20, 0x30, 0x01, 0x00};
    int SET_BLANK_OFF[]     = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xfb, 0xd8, 0x01, 0x00, 0x20, 0x30, 0x00, 0x00};
    // Command,                      Header------------------------,----CRC----, --Action--,----Type----, Setting Code
    int SET_INPUT_HDMI_1[]         = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x0e, 0xd2, 0x01, 0x00, 0x00, 0x20, 0x03, 0x00};
    int SET_INPUT_HDMI_2[]         = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x6e, 0xd6, 0x01, 0x00, 0x00, 0x20, 0x0d, 0x00};
    int SET_INPUT_COMPUTER_1[]     = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xfe, 0xd2, 0x01, 0x00, 0x00, 0x20, 0x00, 0x00};
    int SET_INPUT_COMPUTER_2[]     = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x3e, 0xd0, 0x01, 0x00, 0x00, 0x20, 0x04, 0x00};
    int SET_INPUT_VIDEO[]          = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x6e, 0xd3, 0x01, 0x00, 0x00, 0x20, 0x01, 0x00};
    int SET_INPUT_SVIDEO[]         = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x9e, 0xd3, 0x01, 0x00, 0x00, 0x20, 0x02, 0x00};
    int SET_INPUT_USB_A[]          = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x5e, 0xd1, 0x01, 0x00, 0x00, 0x20, 0x06, 0x00};
    int SET_INPUT_USB_B[]          = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xfe, 0xd7, 0x01, 0x00, 0x00, 0x20, 0x0c, 0x00};
    int SET_INPUT_LAN[]            = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xce, 0xd5, 0x01, 0x00, 0x00, 0x20, 0x0b, 0x00};
    int SET_INPUT_COMPONENT[]      = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xae, 0xd1, 0x01, 0x00, 0x00, 0x20, 0x05, 0x00};
    int REQUEST_INPUT[]            = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xcd, 0xd2, 0x02, 0x00, 0x00, 0x20, 0x00, 0x00};
    // Command,                      Header------------------------,----CRC----, --Action--,----Type----, Setting Code
    int REQUEST_LAMP_LOW[]         = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xc2, 0xff, 0x02, 0x00, 0x90, 0x10, 0x00, 0x00};
    int REQUEST_LAMP_HIGH[]        = {0xbe, 0xef, 0x03, 0x06, 0x00, 0x2a, 0xfd, 0x02, 0x00, 0x9e, 0x10, 0x00, 0x00};
    // Command,                      Header------------------------,----CRC----, --Action--,----Type----, Setting Code
    int REQUEST_FILTER_LOW[]       = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xc2, 0xf0, 0x02, 0x00, 0xa0, 0x10, 0x00, 0x00};
    int REQUEST_FILTER_HIGH[]      = {0xbe, 0xef, 0x03, 0x06, 0x00, 0xd6, 0xfc, 0x02, 0x00, 0x9f, 0x10, 0x00, 0x00};
...
void HITACHI_CP_WU8450::connectedToHost() {
    ...
    if(!authenticationRequired) {
        qDebug() << "HITACHI_CP_WU8450::connectedTopHost() No auth";
